...
- `nx e2e cli-e2e` - run E2E tests for the `cli-e2e` library.
  - run vitest setup - `e2e/cli-e2e/setup/global-setup.ts#setup`
    - `nx graph-setup-npm-env cli-e2e`
    - `nx run-many --targets=graph-npm-publish`
    - `nx run-many --targets=graph-npm-install`
  - run tests
  - run vitest teardown - `e2e/cli-e2e/setup/global-setup.ts#teardown`
    - stop server
    - delete folder
